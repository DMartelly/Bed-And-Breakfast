        ...
        <div id="top">
            ...
            <div id="heading">
                <div style="text-align: center; margin-bottom: 20px">
                    <h1> The B&amp;B Willow Lake <!--img style="display: inline-block; width: 75px; height: 75px;" src="img/icons/willowtree.png" /--></h1>
            ...
            <nav>
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li>
                                <a href="rooms/lana.php">
                                Lana
                                </a>
                            </li>
                            <li>
                                <a href="rooms/rosemary.php">
                                Rosemary
                                </a>
                            </li>
                            <li>
                                <a href="rooms/tammy.php">
                                Tammy
                                </a>
                            </li>
                            <li>
                                <a href="rooms/garden.php">
                                Garden
                                </a>
                            </li>
                            <li>
                                <a href="rooms/mia.php">
                                Mia
                                </a>
                            </li>
                            <li>
                                <a href="rooms/gabriel.php">
                                Gabriel
                                </a>
                            </li>
                        </ul>
